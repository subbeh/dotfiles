...
-- SCREENSHOTS
hl.bind("SUPER + SHIFT + 1",              hl.dsp.exec_cmd("hyprshot -m active -o $XDG_TEMP_DIR/screenshots"))
hl.bind("SUPER + SHIFT + 2",              hl.dsp.exec_cmd("hyprshot -m window -o $XDG_TEMP_DIR/screenshots"))
hl.bind("SUPER + SHIFT + 4",              hl.dsp.exec_cmd("hyprshot -m region -o $XDG_TEMP_DIR/screenshots"))
